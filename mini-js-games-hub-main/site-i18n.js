  ...
  const translations = {
    zh: {
      ...
      index: {
        ...
        proBadgesLabel: "热门排行",
        proBadgesTitle: "推荐排行",
        noBadges: "暂无排行数据，开始试玩后这里会自动生成热门榜单。",
        playsCount: "游玩 {count} 次",
        rankingLoading: "正在读取排行榜...",
        rankingClicks: "{count} 次点击",
        rankingServiceOffline: "排行榜服务未启动，当前显示本地试玩记录。",
        ...
        supportEyebrow: "支持计划",
        supportTitle: "支付宝支付支持",
        supportLead: "你可以通过支付宝手机网站支付支持本站持续更新，用于内容维护、活动策划与服务器成本投入。",
        supportTag: "支付宝",
        supportStatusReady: "支付服务已就绪",
        supportStatusMissing: "支付服务未配置",
        supportStatusOffline: "支付服务未启动",
        supportAction: "立即支付",
        supportPlan1: "轻量支持",
        supportPlan2: "内容赞助",
        supportPlan3: "年度支持",
        supportPlan1Desc: "适合日常支持，帮助站点保持稳定更新",
        supportPlan2Desc: "适合专题策划、活动页和内容补充支持",
        supportPlan3Desc: "适合长期支持，用于服务器、内容和持续运营投入",
        supportBenefitTitle: "支持说明",
        supportBenefit1: "支付完成后将跳转返回页，便于继续浏览站点内容",
        supportBenefit2: "当前支付为站点支持性质，不涉及实体发货",
        supportBenefit3: "最终支付状态以支付宝异步通知结果为准",
        supportServiceHint: "如用于正式上线，请将 notify_url、return_url、商户参数替换为生产环境配置。",
    ...
    en: {
      ...
      index: {
        ...
        proBadgesLabel: "Hot Rankings",
        proBadgesTitle: "Recommended Rankings",
        noBadges: "No ranking data yet. Start opening games and this area will populate automatically.",
        playsCount: "{count} plays",
        rankingLoading: "Loading rankings...",
        rankingClicks: "{count} clicks",
        rankingServiceOffline: "Ranking service is offline. Showing local play history instead.",
        ...
        supportTitle: "Alipay Support Entry",
        supportLead: "Support ongoing updates through Alipay mobile website payment, helping cover content maintenance, campaigns, and hosting costs.",
        supportTag: "Alipay",
        supportStatusReady: "Payment service ready",
        supportStatusMissing: "Payment service not configured",
        supportStatusOffline: "Payment service offline",
        supportAction: "Pay Now",
        supportPlan1: "Light Support",
        supportPlan2: "Content Sponsor",
        supportPlan3: "Annual Support",
        supportPlan1Desc: "A small contribution for steady day-to-day updates",
        supportPlan2Desc: "Great for supporting campaigns and new editorial content",
        supportPlan3Desc: "Helps cover hosting, ongoing updates, and operations",
        supportBenefitTitle: "Before you pay",
        supportBenefit1: "You will be redirected back to the site after payment",
        supportBenefit2: "This flow is for site support and does not involve physical delivery",
        supportBenefit3: "Final payment status depends on Alipay async notification",
        supportServiceHint: "For production use, replace notify_url, return_url, and merchant credentials with your live environment settings.",
