  ...
  const translations = {
    zh: {
      ...
      index: {
        ...
        heroTitle: "汇聚精品小游戏内容，打造统一的 Web 游戏展示与分发入口。",
        heroLead: "平台统一整合原生 HTML/JS 小游戏与 Cocos Creator 移动 H5 游戏，支持内容展示、专题推荐、广告承载与多端访问体验。",
    ...
    en: {
      ...
      index: {
        ...
        heroTitle: "A unified showcase and distribution portal for curated web games.",
        heroLead: "The platform brings together raw HTML/JS games and Cocos Creator mobile H5 titles in one destination, with support for featured collections, advertising inventory, and multi-device access.",
